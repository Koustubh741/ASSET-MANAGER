#!/usr/bin/env python3
"""Script to append compatibility wrapper to snmp_service.py"""
...
target_file = r'd:\ASSET-MANAGER\backend\app\services\snmp_service.py'

with open(target_file, 'r', encoding='utf-8') as f:
    content = f.read()

# Check if already added
if 'scan_network_range' in content:
    print("[OK] Compatibility wrapper already exists")
else:
    ...
    print("[OK] Compatibility wrapper added successfully")
