                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {tiers.map((tier, idx) => {
                        ...
                        return (
                            <div
                                key={tier.name}
                                className={`relative group p-6 rounded-3xl bg-slate-900/40 backdrop-blur-xl border-2 ${tier.borderColor} flex flex-col transition-all duration-500 hover:scale-[1.03] hover:bg-slate-900/60 shadow-2xl animate-in fade-in slide-in-from-bottom-8 duration-700`}
                            ...
                            >
                                ...
                                <p className="text-slate-400 text-xs mb-8 leading-relaxed min-h-[40px]">
                                    {tier.description}
                                </p>
