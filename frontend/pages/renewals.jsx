        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-[#1e293b] rounded-2xl w-full max-w-md border border-slate-200 dark:border-white/10 p-6 shadow-2xl">
                ...
                <div className="flex justify-end gap-3 mt-6">
                    <button onClick={onClose} className="px-4 py-2 text-sm text-slate-700 dark:text-slate-700 hover:text-slate-900 dark:hover:text-white transition-colors">Cancel</button>
                    <button
