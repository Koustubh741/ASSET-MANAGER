...
import { ArrowLeft, User, MapPin, Calendar, Activity, Server, Shield, QrCode, ScanBarcode, AlertCircle, Download, Edit2, Save, X } from 'lucide-react'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="backdrop-blur-md bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl rounded-xl transition-all duration-300 hover:border-blue-500/30 p-6 relative overflow-hidden">
                        ...
                        <div className="z-10 bg-slate-900/40 rounded-xl border border-white/5 mt-4">
                    ...
                    <div className="glass-panel p-6">
                        ...
                        {isEditingWarranty ? (
                            <div className="space-y-5">
                                ...
                                <div>
                                    <label className="block text-sm text-slate-400 mb-2">Warranty Expiry</label>
                                    <div className="flex items-center">
                                        <Calendar size={16} className="mr-2 text-orange-400" />
                                        <input
                                            type="date"
                                ...
                                <div className="flex space-x-2 pt-2">
                                    ...
                                    <button
                                        ...
                                        disabled={savingWarranty}
                                        className="flex-1 flex items-center justify-center space-x-2 px-4 py-2 rounded-lg bg-slate-500/20 hover:bg-slate-500/30 text-slate-400 border border-slate-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <X size={16} />
                                        <span>Cancel</span>
                                    </button>
