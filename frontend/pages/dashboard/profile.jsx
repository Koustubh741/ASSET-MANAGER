    ...
    return (
        <div className="max-w-6xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-2xl font-['Outfit'] font-black text-slate-900 dark:text-white uppercase tracking-tight">Identity Profile</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="glass-panel p-10 border border-slate-200 dark:border-white/10 shadow-2xl bg-white dark:bg-slate-900/60 transition-all flex flex-col items-center text-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10 mt-6">
                            <div className="w-32 h-32 rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-blue-600 flex items-center justify-center border-4 border-white dark:border-slate-800 shadow-2xl group-hover:scale-105 transition-transform duration-500">
                                <span className="text-2xl font-black text-slate-900 dark:text-white drop-shadow-lg">
                            ...
                            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-emerald-500 rounded-2xl border-4 border-white dark:border-slate-900 flex items-center justify-center shadow-lg">
                                <CheckCircle size={18} className="text-slate-900 dark:text-white" />
                            </div>
                        </div>

                        <div className="relative z-10 mt-8 space-y-2">
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">{displayProfile.name}</h2>
                            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">{displayProfile.email}</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="glass-panel p-6 border border-slate-200 dark:border-white/5 bg-white dark:bg-transparent">
                            <p className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Active Assets</p>
                            <p className="text-xl font-black text-indigo-500">{assignedAssets.length}</p>
                        </div>
                        <div className="glass-panel p-6 border border-slate-200 dark:border-white/5 bg-white dark:bg-transparent">
                            <p className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Account Age</p>
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="glass-panel p-8 border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 rounded-[2.5rem] space-y-8">
                        <div className="flex items-center gap-4 border-b border-black/5 dark:border-white/5 pb-6">
                            ...
                            <div>
                                <h3 className="text-base font-black text-slate-900 dark:text-white uppercase tracking-widest">Security Configuration</h3>
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-0.5">Access Control & Encryption</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-3xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:bg-slate-100 dark:hover:bg-slate-100 dark:bg-white/5 transition-all group/item">
                                    <div className="flex justify-between items-start">
                                        <div className="flex items-center gap-4">
                                            <div className="p-2.5 rounded-xl bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover/item:text-indigo-500 transition-colors">
                                                <item.icon size={18} />
                                            </div>
                                            <div>
                                                <p className="text-sm font-black text-slate-800 dark:text-white uppercase tracking-tight">{item.label}</p>
                                                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 italic">{item.value}</p>
                                            </div>
                                        </div>
                    ...
                    <div className="glass-panel p-8 border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/40 rounded-[2.5rem] space-y-8">
                        <div className="flex items-center gap-4 border-b border-black/5 dark:border-white/5 pb-6">
                            ...
                            <div>
                                <h3 className="text-base font-black text-slate-900 dark:text-white uppercase tracking-widest">Assigned Hardware Fleet</h3>
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-0.5">Inventory Tracking & Status</p>
                            </div>
                        </div>

                        <div className="space-y-4">
                            {assignedAssets.length > 0 ? assignedAssets.map((asset) => (
                                <div key={asset.id} className="flex items-center justify-between p-6 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 rounded-3xl group/asset">
                                    <div className="flex items-center gap-6">
                                        <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 group-hover/asset:text-blue-500 transition-colors shadow-sm">
                                        ...
                                        <div>
                                            <p className="text-base font-bold text-slate-900 dark:text-white">{asset.name}</p>
                                            <div className="flex items-center gap-3 mt-1">
                                                <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">{asset.asset_type}</span>
                                                <span className="w-1 h-1 rounded-full bg-slate-400"></span>
                                                <span className="text-[10px] font-mono text-slate-500 dark:text-slate-400 tracking-tighter">S/N: {asset.serial_number || 'N/A'}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-2">Health: Optimal</p>
                                    </div>
                                </div>
                            )) : (
                                <div className="text-center py-10">
                                    <p className="text-slate-500 dark:text-slate-400 text-sm italic">No hardware currently assigned to this profile.</p>
                                </div>
                            )}
                        </div>
                    </div>
