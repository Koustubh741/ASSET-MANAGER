                    ...
                    <div className="shrink-0 py-4 md:py-6">
                        ...
                        <header className="mt-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h1 className="text-2xl font-bold text-app-text">Procurement updates</h1>
                            </div>
                        ...
                        {procurementRelated.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {procurementRelated.map((req) => (
                                    <div
                                        key={req.id}
                                        className="rounded-xl border border-app-border bg-app-surface-soft overflow-hidden hover:border-amber-500/20 transition-colors"
                                    >
