...
/**
 * Finance Settings – scoped to Finance hub.
        ...
        <div className="space-y-6">
            <header>
                ...
                <p className="text-app-text-muted text-app-text-muted mt-1">
                    Preferences and account information for the Finance hub.
                </p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <section className="glass-card p-5">
                    ...
                    <p className="text-xs text-app-text-muted text-app-text-muted">
                        Control which Finance events send alerts (e.g. Budget request, PO finalized).
                    </p>
                ...
                <section className="glass-card p-5">
                    ...
                    <p className="text-xs text-app-text-muted text-app-text-muted">
                        Configure default thresholds and budget allocation rules.
                    </p>
                    <p className="mt-3 text-[11px] text-app-text-muted italic">
                ...
                <section className="glass-card p-5">
                    ...
                    <p className="text-xs text-app-text-muted text-app-text-muted">
                        View how Finance visibility is scoped across departments and domains.
                    </p>
                    <p className="mt-3 text-[11px] text-app-text-muted italic">
