    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="glass-panel p-8 border border-app-border shadow-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-app-border hover:border-blue-500/30 transition-all text-center group">
            ...
            <div className="flex flex-wrap gap-4">
                <button className="px-6 py-3 rounded-2xl bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50 hover:scale-105 active:scale-95 transition-all">
