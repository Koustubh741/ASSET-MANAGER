            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="relative flex-1">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <Search className="h-5 w-5 text-app-text-muted text-app-text-muted" />
                    </div>
                    <input
                        type="text"
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 lg:pb-0 font-sans">
                    ...
                    {(filters.search || filters.status !== 'All' || filters.category !== 'All' || filters.department !== 'All' || filters.warranty !== 'All') && (
                        <button
                            ...
                            className="p-2.5 text-app-text-muted text-app-text-muted hover:text-slate-900 dark:hover:text-white transition-colors"
                            title="Clear Filters"
                        >
                            <X size={20} />
                        </button>
