...
# Insert at line 503 (after the closing of Agent Discoveries modal)
$newLines = $lines[0..502] + $modalLines + $lines[503..($lines.Count - 1)]
Set-Content -Path $filePath -Value $newLines
Write-Host "Successfully inserted Agent Details modal at line 503"
